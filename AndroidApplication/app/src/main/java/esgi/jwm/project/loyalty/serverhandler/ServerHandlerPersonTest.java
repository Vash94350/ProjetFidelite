...
//    private final String urlNodeJs = "http://" +ipServ + portNodeJs + "/" + person;
    ...
    public void login(String mail, String password, APICallback apiCallback) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, ServerHandler.webServiceURL + person + login ,parameters,
    ...
    public void register(String mail, String password, String telephone, String firstname,
                         ...
                         String route, String zipCode, String city, String country, String webSiteCompleteURL, APICallback callback) {
        ...
        listParams = prepareHashMap(context.getString(R.string.email_data_label), mail,
                ...
                context.getString(R.string.webSiteCompleteURL), webSiteCompleteURL);

        JSONObject parameters = new JSONObject(listParams);

        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, ServerHandler.webServiceURL + person + register ,parameters,
